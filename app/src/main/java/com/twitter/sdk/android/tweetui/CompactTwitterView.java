...
public class CompactTwitterView extends BaseTweetView {
    ...
    public CompactTwitterView(Context context, Tweet tweet) {
        super(context, tweet);
    }

    public CompactTwitterView(Context context, Tweet tweet, int styleResId) {
        super(context, tweet, styleResId);
    }

    CompactTwitterView(Context context, Tweet tweet, int styleResId,
                     DependencyProvider dependencyProvider) {
        super(context, tweet, styleResId, dependencyProvider);
    }

    public CompactTwitterView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CompactTwitterView(Context context, AttributeSet attrs, int defStyle) {
